...
const EVENT_TEMPLATES = [
  {
    ...
    period: {
      start: "2025-06-22T19:47:30.744Z",
      end: "2025-06-29T19:47:30.744Z",
    },
  },
  {
    ...
    period: {
      start: "2025-10-10T05:00:32.871Z",
      end: "2025-11-02T05:00:32.871Z",
    },
  },
  {
    ...
    period: {
      start: "2025-08-02T06:13:45.539Z",
      end: "2025-08-22T06:13:45.539Z",
    },
  },
  {
    ...
    period: {
      start: "2025-06-05T11:47:04.413Z",
      end: "2025-07-05T11:47:04.413Z",
    },
  },
  {
    ...
    period: {
      start: "2026-03-17T19:55:35.974Z",
      end: "2026-04-10T19:55:35.974Z",
    },
  },
  {
    ...
    period: {
      start: "2025-09-17T05:50:35.916Z",
      end: "2025-09-29T05:50:35.916Z",
    },
  },
  {
    ...
    period: {
      start: "2025-08-14T14:16:04.252Z",
      end: "2025-08-31T14:16:04.252Z",
    },
  },
  {
    name: "Feil LLC Event",
    ...
    period: {
      start: "2025-07-06T20:14:16.724Z",
      end: "2025-07-16T20:14:16.724Z",
    },
  },
];
...
export default function (data: { authToken: string }): void {
  ...
  const minPurchase = Math.max(
    100,
    templateEvent.condition.minPurchase +
      Math.floor(Math.random() * 1000) -
      500,
  );
  const maxRewards = Math.max(
    1,
    templateEvent.condition.maxRewards + Math.floor(Math.random() * 2) - 1,
  );
  ...
  const response = http.post(`${API_BASE_URL}/events`, eventPayload, {
    headers: {
  ...
  const success = check(response, {
    ...
    "event name matches": (r) =>
      r.json("name") !== undefined &&
      (r.json("name") as string).includes("Event"),
    "condition exists": (r) => {
